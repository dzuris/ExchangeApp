...
public partial class BusinessCustomerViewModel : ViewModelBase
{
    ...
    public BusinessCustomerViewModel(ICustomerFacade customerFacade, ITransactionFacade transactionFacade, ISettingsFacade settingsFacade, IPrinterService printerService)
    {
